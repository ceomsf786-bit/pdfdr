...
const CACHE = 'snt-pdf-static-v3-11';
const STATIC = ['./','./index.html','./teacher.html','./viewer.css','./viewer.js','./config.js','./v310-backup.css','./v310-backup.js','./v311-library.css','./v311-library.js'];
