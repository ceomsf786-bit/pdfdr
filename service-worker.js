// v3.27 fresh PDF revision key after insertion
...
// v3.22 student PDF + teacher website visible together with draggable split
// v3.21 student links open inside the PDF viewer page
// v3.20 saved teacher/student links
// v3.19 student PDF cache isolation fix
// v3.18 opacity control removed for stability; solid fills only
// selected shape colour/width editing retained
...
const CACHE = 'snt-pdf-static-v3-27';
